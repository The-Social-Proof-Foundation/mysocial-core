...
use crate::mysocial_serde::Readable;
use crate::mysocial_serde::{to_sui_struct_tag_string, HexAccountAddress};
...
impl MoveObjectType {
    ...
    pub fn address(&self) -> AccountAddress {
        match &self.0 {
            MoveObjectType_::GasCoin | MoveObjectType_::Coin(_) => MYSO_FRAMEWORK_ADDRESS,
            MoveObjectType_::StakedSui => MYSO_SYSTEM_ADDRESS,
    ...
    pub fn is_upgrade_cap(&self) -> bool {
        self.address() == MYSO_FRAMEWORK_ADDRESS
...
pub fn is_primitive_type_tag(t: &TypeTag) -> bool {
    ...
    match t {
        ...
        T::Struct(st) => {
            ...
            // is id or..
            if resolved_struct == RESOLVED_MYSO_ID {
                return true;
            }
            // is utf8 string
...
impl FromStr for ObjectType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        if s.to_lowercase() == PACKAGE {
            ...
            let tag = crate::parse_myso_struct_tag(s)?;
...
impl TxContext {
    ...
    pub fn kind(view: &CompiledModule, s: &SignatureToken) -> TxContextKind {
        ...
        let is_tx_context_type = module_name == TX_CONTEXT_MODULE_NAME
            && module_addr == &MYSO_FRAMEWORK_ADDRESS
