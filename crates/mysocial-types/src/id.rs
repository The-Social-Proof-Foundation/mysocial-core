...
use crate::{base_types::ObjectID, MYSO_FRAMEWORK_ADDRESS};
...
pub const RESOLVED_MYSO_ID: (&AccountAddress, &IdentStr, &IdentStr) =
    (&MYSO_FRAMEWORK_ADDRESS, OBJECT_MODULE_NAME, ID_STRUCT_NAME);
// For backwards compatibility
pub const RESOLVED_SUI_ID: (&AccountAddress, &IdentStr, &IdentStr) = RESOLVED_MYSO_ID;
